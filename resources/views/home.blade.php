    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="top-title-area">
                <h1 class="top-title">Backlog Boostar Tools</h1>
                <img src="{{ url('/img/booster.png') }}" class="topimg" />
            </div>
            <div class=" tool-list-wrapper">
                <h2><a href=" aggregate/">期間集計ツール<br class="br-sp"><span>Period Aggregation Tool</span></a></h2>
                <p>プロジェクトごとの指定期間内での作業実績時間を集計します。</p>
            </div>
            <div class="tool-list-wrapper">
                <h2><a href="send/">一斉送信ツール<br class="br-sp"><span>Send Group Tool</span></a></h2>
                <p>同じ投稿をバックログの複数プロジェクトに一斉送信できるツールです。</p>
            </div>
            <div class="tool-list-wrapper">
                <h2><a href="dailyreport/">日報作成ツール<br class="br-sp"><span>Daily Report Generate Tool</span></a></h2>
