...
<div class="container">
  <div class="row">
    <div class="col-lg-12 mb-4 mt-2 bl-ag-usg">
      ...
      <p>メンバー登録いただいている方の場合、「本日分」「昨日分」どちらの日報を作成するかを選択し「日報作成」ボタンを押下してください。</p>
      <img src="{{ url('/img/manuals/dailyreport/dailyreport_member.png') }}" />
      <p>メンバー未登録の方の場合、「本日分」「昨日分」どちらの日報を作成するかの選択とユーザーID、APIキー、ホスト名を入力し「日報作成」ボタンを押下してください。</p>
