@extends('layouts.app')
@section('title', '基本設定のマニュアル')
@section('description', 'Backlog 基本設定のマニュアルです。')
@section('content')
<div class="container">
  <div class="row">
    <div class="col-lg-12 mb-4 mt-2 bl-ag-usg">
      ...
      <ul>
        ...
        <li>
          プロジェクト: 当ツールで使うプロジェクトキーと担当者を入力します。必要な数だけ「追加」ボタンで追加できます。期間集計ツールのプロジェクト選択、一斉送信ツールのプロジェクト選択、担当者設定で使用します。
        </li>
      </ul>
