...
<div class="container">
  <div class="row">
    <div class="col-lg-12 mb-4 mt-2 bl-ag-usg">
      ...
      <p>会員登録済みの方はタイトルと本文を入れ、登録したプロジェクトキー一覧・担当者の組み合わせから、送信したいプロジェクトのプロジェクトキーをお選びいただき「送信内容確認」ボタンを押してください。</p>
      <img src="{{ url('/img/manuals/send/send_member_1.png') }}" />
      <p>会員登録しないでご利用される方はタイトルと本文、プロジェクトキー・担当者のペアをカンマ区切りで入れ、必要な分だけ「追加」ボタンで追加いただき、APIキー、ホスト名を入力して「送信内容確認」ボタンを押してください。</p>
